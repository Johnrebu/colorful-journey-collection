    ...
    >
      ...
      >
        <div className="flex items-center mb-3">
          <GraduationCap className="w-5 h-5 text-gray-600 dark:text-gray-400 mr-3" />
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Educational Background</h3>
        </div>
        <p className="mb-4 leading-relaxed text-gray-700 dark:text-gray-300 ml-8">
      ...
      >
        <div className="flex items-center mb-3">
          ...
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Transition to Technology</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className="flex items-center mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Personal Interests</h3>
            </div>
            <p className="leading-relaxed text-gray-700 dark:text-gray-300 ml-8">
          ...
          <div>
            <div className="flex items-center mb-3">
              <Target className="w-5 h-5 text-gray-600 dark:text-gray-400 mr-3" />
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Future Goals</h3>
            </div>
            <p className="leading-relaxed text-gray-700 dark:text-gray-300 ml-8">
